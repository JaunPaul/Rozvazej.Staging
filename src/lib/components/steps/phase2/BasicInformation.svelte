    ...
    <div class="input-group-wrap">
      ...
      <div class="input-wrap relative">
        ...
        <input
          ...
          bind:value={registrationState.values.permanentResidenceStreetNumber}
        />
        <Errors
          errors={registrationState.errors}
...
<div in:fade class="box has-8-gap">
  ...
  {/if}
  <div class="input-wrap">
    <label for="transport" class="field-label">{t("labels.transport")}</label>
    <select
      class="input-2"
      id="transport"
      name="transport"
    ...
    >
      <option value="" disabled>{t("select.placeholder.transport")}</option>
